...
- **EX-0004 expansion authority:** on 2026-07-17 the owner said “I approve and go on with it” after replay and supplied pond-board art references. This authorizes UI/art expansion of EX-0004 in the active `SEQ-M1` / `MES-01 → MES-02` bridge context.
- **EX-0005 expansion authority:** on 2026-07-18 the owner approved mechanic expansion for EX-0005 after replay, including its bounded prediction bridge, while explicitly withholding approval of any `MES-02` learning contract. This authorizes full progression, interaction, motion, and art-direction work for the replacement log-roll exercise only; it does not revive the superseded trace-debugger.
- **Still not authorized:** the `MES-02` learning contract, full `SEQ-M1`, efficacy claims, promotion, or unrelated implementation. No prescribed approval phrase is required; bounded implementation should use a Khazad-Doom Issue Slice when a hard fence is useful.

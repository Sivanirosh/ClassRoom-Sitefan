...
**Travail maintenant autorisé :** poursuivre séparément l’expansion des exercices EX-0004 et EX-0005 dans leurs périmètres enregistrés après replay. Une approbation naturelle et claire du propriétaire suffit pour passer à l’expansion dans le contexte actif; aucune formule exacte n’est exigée. Les limites techniques du travail sont portées, lorsque nécessaire, par une Issue Slice Khazad-Doom validée. EX-0004 a reçu cette approbation le 2026-07-17; EX-0005 l’a reçue le 2026-07-18, y compris pour son pont de prédiction borné. Le contrat `MES-02`, le reste de `SEQ-M1`, `MES-04`, `MES-06` et le pacing global demeurent non approuvés.

...
**Travail maintenant autorisé :** créer un exercice catalogue low-fi `MES-01` distinct pour chaque candidat, sous ses contraintes enregistrées, puis rejouer chacun indépendamment. Une approbation naturelle et claire du propriétaire suffit pour passer à l’expansion dans le contexte actif; aucune formule exacte n’est exigée. Les limites techniques du travail sont portées, lorsque nécessaire, par une Issue Slice Khazad-Doom validée. EX-0004 a reçu cette approbation le 2026-07-17; EX-0005 attend encore son replay. Le contrat `MES-02`, le reste de `SEQ-M1`, `MES-04`, `MES-06` et le pacing global demeurent non approuvés.
